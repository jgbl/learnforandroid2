...
public class ScaledArrayAdapter<T> extends AbstractScaledArrayAdapter<T> {
    ...
    public static ScaledArrayAdapter<CharSequence> createFromResource(Context context, int textArrayResId, int textViewResId)
	        {
    			ArrayAdapter<CharSequence> A = ArrayAdapter.createFromResource(context, textArrayResId, textViewResId);
				ScaledArrayAdapter<CharSequence> SA = new ScaledArrayAdapter<CharSequence>(context, textViewResId);
